...
T = TypeVar("T", bound="ProductReleaseInfoCreate")


@attr.s(auto_attribs=True)
class ProductReleaseInfoCreate:
    """
    Attributes:
        price (Union[Unset, None, int]):
        tax_including (Union[Unset, bool]):
    ...
    tax_including: Union[Unset, bool] = False
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        product_release_info_create = cls(
            price=price,
        ...
        product_release_info_create.additional_properties = d
        return product_release_info_create
