...
T = TypeVar("T", bound="ProductReleaseInfoInDB")


@attr.s(auto_attribs=True)
class ProductReleaseInfoInDB:
    """
    Attributes:
        id (int):
        product_id (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        product_release_info_in_db = cls(
            id=id,
            product_id=product_id,
            created_at=created_at,
            updated_at=updated_at,
        ...
        product_release_info_in_db.additional_properties = d
        return product_release_info_in_db
